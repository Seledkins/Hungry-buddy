...
function fd_rectangle_set_acceleration(rectangle_id, x_acceleration, y_acceleration, a = undefined, b = undefined) {
	...
	with (rectangle_id) {
	    ...
	    if (argument_count > 3 && !is_undefined(a)) acceleration_a = a; else acceleration_a = 0;
	    if (argument_count > 4 && !is_undefined(b)) acceleration_b = b; else acceleration_b = 0;
