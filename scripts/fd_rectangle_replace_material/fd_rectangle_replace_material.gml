...
function fd_rectangle_replace_material(rectangle_id, _sprite_index, _image_index, _x, _y, xscale, yscale, color, alpha) {
	...
	with (rectangle_id) {
	    fd_rectangle_set_target(id, FD_TARGET_TYPE.REPLACE_MATERIAL);
	        draw_sprite_ext(_sprite_index, _image_index, _x, _y, xscale, yscale, 0, color, alpha);
