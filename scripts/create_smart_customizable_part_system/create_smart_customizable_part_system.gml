...
function create_smart_customizable_part_system(_x, _y, _life_time, _ps_and_ptype_struct, _layer = o_play_values_manager.layid_particles, _depth = -1){

	var smart_particle_system = instance_create_layer(_x, _y, _layer, o_smart_customizable_part_system, {
		ps_and_ptype_struct : _ps_and_ptype_struct,
