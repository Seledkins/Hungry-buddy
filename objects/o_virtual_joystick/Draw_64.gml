...
draw_sprite_ext(sprite_bg, 0, bg_x, bg_y, scale, scale, 0, bg_color, alpha);
...
if (point_in_rectangle(mouse_x_, mouse_y_, x1_zone_drag, y1_zone_drag, x2_zone_drag, y2_zone_drag) and touching) // in drag zone
{
	...
	draw_sprite_ext(sprite_joystick, 0, joystick_x, joystick_y, scale, scale, 0, joystick_color, alpha);
